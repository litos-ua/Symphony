 ...
 */
final class Version20230131014124 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE url_codes MODIFY id INT NOT NULL');
        $this->addSql('DROP INDEX code_UNIQUE ON url_codes');
        $this->addSql('DROP INDEX `primary` ON url_codes');
        $this->addSql('ALTER TABLE url_codes CHANGE code code VARCHAR(12) NOT NULL, CHANGE url url VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE url_codes ADD PRIMARY KEY (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE url_codes MODIFY id INT NOT NULL');
        $this->addSql('DROP INDEX `PRIMARY` ON url_codes');
        $this->addSql('ALTER TABLE url_codes CHANGE code code VARCHAR(32) NOT NULL, CHANGE url url VARCHAR(256) NOT NULL');
        $this->addSql('CREATE UNIQUE INDEX code_UNIQUE ON url_codes (code)');
        $this->addSql('ALTER TABLE url_codes ADD PRIMARY KEY (id, code)');
    }
}
